...
public class CassandraFourOneSchemaChangeListener extends AbstractSchemaChangeListener {
    ...
    public void onKeyspaceCreated(final KeyspaceMetadata keyspaceMetadata) {
        try {
            ...
            Schema.instance.transform(SchemaTransformations.addKeyspace(newKMD, true));
    ...
    public void onKeyspaceUpdated(final KeyspaceMetadata current, final KeyspaceMetadata previous) {
        try {
            Schema.instance.transform(SchemaTransformations.addKeyspace((org.apache.cassandra.schema.KeyspaceMetadata.create(
                    current.getName().asInternal(),
                    KeyspaceParams.create(current.isDurableWrites(),
                            current.getReplication()))), true));
    ...
    public void onKeyspaceDropped(final KeyspaceMetadata keyspaceMetadata) {
        try {
            ...
            Schema.instance.transform(current -> current.without(Collections.singletonList(keyspaceMetadata.getName().toString())));
    ...
    public void onTableCreated(com.datastax.oss.driver.api.core.metadata.schema.TableMetadata tableMetadata) {
        ...
        try {
            ...
            Schema.instance.transform(SchemaTransformations.addKeyspace(transformed, true));
    ...
    public void onTableDropped(com.datastax.oss.driver.api.core.metadata.schema.TableMetadata tableMetadata) {
        ...
        try {
            ...
            if (cfm.isPresent()) {
                ...
                Schema.instance.transform(SchemaTransformations.addKeyspace(newKsm, true));
