...
public class SnapshotProcessorTest extends EmbeddedCassandra4ConnectorTestBase {
    @Test
    public void testSnapshotTable() throws Exception {
        CassandraConnectorContext context = generateTaskContext();
        SnapshotProcessor snapshotProcessor = Mockito.spy(new SnapshotProcessor(context, new CassandraFourOneTypeProvider().getClusterName()));
    ...
    public void testSnapshotModeAlways() throws Exception {
        ...
        SnapshotProcessor snapshotProcessorSpy = Mockito.spy(new SnapshotProcessor(context, new CassandraFourOneTypeProvider().getClusterName()));
